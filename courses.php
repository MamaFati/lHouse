              ...
              <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                <a class="position-relative d-block overflow-hidden" href="">
                  ...
                  <div
                    ...
                    style="margin: 1px"
                  >
                    <h5 class="m-0">ESSENTIALS</h5>
                    <small class="text-primary">GROUP COURSE</small>
                  </div>
                </a>
              </div>
              <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                <a class="position-relative d-block overflow-hidden" href="">
                  ...
                  <div
                    ...
                    style="margin: 1px"
                  >
                    <h5 class="m-0">CRASH COOURSE 1</h5>
                    <small class="text-primary">GROUP COURSE</small>
                  </div>
                </a>
              </div>
              <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                <a class="position-relative d-block overflow-hidden" href="">
                  ...
                  <div
                    ...
                    style="margin: 1px"
                  >
                    <h5 class="m-0">CRASH COOURSE 2</h5>
                    <small class="text-primary">GROUP COURSE</small>
                  </div>
                </a>
              </div>
          ...
          >
            <a class="position-relative d-block h-100 overflow-hidden" href="">
              ...
              >
                ...
                <small class="text-primary">PERSONAILZED EXPERIENCE</small>
              </div>
            </a>
          </div>
        </div>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="course-item bg-light">
              ...
              <div class="text-center p-4 pb-0">
                ...
                <h5 class="mb-4">
                 ESSENTIALS & GROUP COURSES
                </h5>
              </div>
              <div class="d-flex border-top">
                <small class="flex-fill text-center border-end py-2"
                  ><i class="fa fa-user-tie text-primary me-2"></i>Abaani
                  </small
                >
                <small class="flex-fill text-center border-end py-2"
                  ><i class="fa fa-clock text-primary me-2"></i>1.00 Hrs</small
                >
                <small class="flex-fill text-center py-2"
                  ><i class="fa fa-user text-primary me-2"></i>90
                  Students</small
                >
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="course-item bg-light">
              ...
              <div class="text-center p-4 pb-0">
                ...
                <h5 class="mb-4">
                  CRASH COURSE 1 &  GROUP COURSE
                </h5>
              </div>
              <div class="d-flex border-top">
                <small class="flex-fill text-center border-end py-2"
                  ><i class="fa fa-user-tie text-primary me-2"></i> Fati
                  Mama</small
                >
                <small class="flex-fill text-center border-end py-2"
                  ><i class="fa fa-clock text-primary me-2"></i>2.00 Hrs</small
                >
                <small class="flex-fill text-center py-2"
                  ><i class="fa fa-user text-primary me-2"></i>10
                  Students</small
                >
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="course-item bg-light">
              ...
              <div class="text-center p-4 pb-0">
                ...
                <h5 class="mb-4">
                 CRASH COURSE 2 &  GROUP COURSE
                </h5>
              </div>
              <div class="d-flex border-top">
                <small class="flex-fill text-center border-end py-2"
                  ><i class="fa fa-user-tie text-primary me-2"></i>Salau
                  </small
                >
                <small class="flex-fill text-center border-end py-2"
                  ><i class="fa fa-clock text-primary me-2"></i>1.50 Hrs</small
                >
                <small class="flex-fill text-center py-2"
                  ><i class="fa fa-user text-primary me-2"></i>10
                  Students</small
